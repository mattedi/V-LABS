...
load_dotenv(dotenv_path=".env")  # Certifique-se que o caminho está correto

# MongoDB
mongo_uri = os.getenv("MONGO_URI")
print("✅ URI Mongo:", mongo_uri)  # Diagnóstico

if not mongo_uri:
    raise ValueError("❌ Variável MONGO_URI não carregada. Verifique o .env.")
...
if not qdrant_url or not qdrant_api_key:
    raise ValueError("❌ Variáveis Qdrant não carregadas. Verifique o .env.")
...
print("🧪 Coleções MongoDB:", client.list_database_names())
print("🧪 Coleções Qdrant:", qdrant_client.get_collections())
